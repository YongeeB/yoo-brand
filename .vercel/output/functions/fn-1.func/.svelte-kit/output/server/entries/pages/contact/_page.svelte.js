...
const css$1 = {
  code: "#opaque.svelte-1lfot6z.svelte-1lfot6z{position:relative;opacity:40%;z-index:-2}.center-box.svelte-1lfot6z.svelte-1lfot6z{position:absolute;inset:0;height:100vh;display:flex;flex-direction:column;justify-content:center;align-items:center}.form-container.svelte-1lfot6z.svelte-1lfot6z{width:100%}.form-container.svelte-1lfot6z form.svelte-1lfot6z{width:100%;display:flex;flex-direction:column;justify-content:center;align-items:center}.form-container.svelte-1lfot6z form input.svelte-1lfot6z{caret-color:var(--tertiary-color);width:80%;max-width:250px;height:40px;margin-bottom:2em;border-radius:5px;padding:1em;box-sizing:border-box;font-size:16px;font-weight:bolder;box-sizing:border-box}.form-container.svelte-1lfot6z form input.svelte-1lfot6z:nth-child(1){text-transform:capitalize}.form-container.svelte-1lfot6z form input.svelte-1lfot6z:focus{outline:none;border:1px solid var(--tertiary-color)}.form-container.svelte-1lfot6z form button.svelte-1lfot6z{border:none;padding:8px 1em;border-radius:5px;color:black;background-color:var(--tertiary-color);font-weight:bolder;font-size:0.9em}",
  map: null
};
const Form = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="center-box svelte-1lfot6z"${add_attribute("id", !collapse && "opaque", 0)}>${validate_component(ContactUs, "ContactUs").$$render($$result, {}, {}, {})} <div class="form-container svelte-1lfot6z"><form class="svelte-1lfot6z"><input type="text" placeholder="Full Name" class="svelte-1lfot6z"${add_attribute("this", inputRef, 0)}> <input type="text" placeholder="Email" class="svelte-1lfot6z"> <input type="text" placeholder="Message" class="svelte-1lfot6z"> <button class="svelte-1lfot6z" data-svelte-h="svelte-11upy20">send</button></form></div> ${validate_component(Visit, "Visit").$$render($$result, {}, {}, {})} </div>`;
});
