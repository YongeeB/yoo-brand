...
const css$1 = {
  code: "#opaque.svelte-1hvfirt.svelte-1hvfirt{position:relative;opacity:40%;z-index:-2}.center-box.svelte-1hvfirt.svelte-1hvfirt{position:absolute;inset:0;height:100vh;display:flex;flex-direction:column;justify-content:center;align-items:center}.form-container.svelte-1hvfirt.svelte-1hvfirt{width:100%}.form-container.svelte-1hvfirt form.svelte-1hvfirt{width:100%;display:flex;flex-direction:column;justify-content:center;align-items:center}.form-container.svelte-1hvfirt form input.svelte-1hvfirt{caret-color:var(--tertiary-color);width:80%;max-width:250px;height:40px;margin-bottom:2em;border-radius:5px;padding:1em;box-sizing:border-box;font-size:16px;font-weight:bolder;box-sizing:border-box}.form-container.svelte-1hvfirt form input.svelte-1hvfirt:nth-child(1){text-transform:capitalize}.form-container.svelte-1hvfirt form input.svelte-1hvfirt:focus{outline:none;border:1px solid var(--tertiary-color)}.form-container.svelte-1hvfirt form button.svelte-1hvfirt{border:none;padding:8px 1em;border-radius:1em;color:black;background-color:var(--tertiary-color);font-weight:bolder;font-size:0.9em}",
  map: null
};
const Form = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="center-box svelte-1hvfirt"${add_attribute("id", !collapse && "opaque", 0)}>${validate_component(ContactUs, "ContactUs").$$render($$result, {}, {}, {})} <div class="form-container svelte-1hvfirt"><form class="svelte-1hvfirt"><input type="text" placeholder="Full Name" class="svelte-1hvfirt"${add_attribute("this", inputRef, 0)}> <input type="text" placeholder="Email" class="svelte-1hvfirt"> <input type="text" placeholder="Message" class="svelte-1hvfirt"> <button class="svelte-1hvfirt" data-svelte-h="svelte-11upy20">send</button></form></div> ${validate_component(Visit, "Visit").$$render($$result, {}, {}, {})} </div>`;
});
