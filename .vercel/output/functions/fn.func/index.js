...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.8a90f07d.js", "_app/immutable/chunks/layout.d3360e33.js", "_app/immutable/chunks/scheduler.3339ba20.js", "_app/immutable/chunks/index.22f5a88e.js"];
    stylesheets = [];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.d044a458.js", "_app/immutable/chunks/scheduler.3339ba20.js", "_app/immutable/chunks/index.22f5a88e.js", "_app/immutable/chunks/singletons.42be40a7.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});

// .svelte-kit/output/server/entries/pages/contact/_layout.js
var layout_exports2 = {};
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    init_layout2();
    index3 = 2;
    component3 = async () => (await Promise.resolve().then(() => (init_layout_svelte(), layout_svelte_exports))).default;
    universal_id2 = "src/routes/contact/+layout.js";
    imports3 = ["_app/immutable/nodes/2.8a90f07d.js", "_app/immutable/chunks/layout.d3360e33.js", "_app/immutable/chunks/scheduler.3339ba20.js", "_app/immutable/chunks/index.22f5a88e.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});
...
var globals, Raw, css$1, Svg, Object_1, outerScale, Icon, home, shoppingCart, phone, phoneSquare, moonO, productHunt, css, Theme;
  ...
  ".svelte-kit/output/server/chunks/Theme.js"() {
    ...
    Theme = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.scale === void 0 && $$bindings.scale && scale !== void 0)
        $$bindings.scale(scale);
      $$result.css.add(css);
      return `  <div class="theme">${validate_component(Icon, "Icon").$$render(
        $$result,
        {
          data: moonO,
          scale,
...
var css$5, TopBar, css$4, Links, css$3, Name, placeholderClass, Placeholder, Src, css$2, Product, PRODUCTS, css$12, _Layout_$1, css2, YooBrandInfo, _Layout_, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    init_ssr();
    init_Theme();
    css$5 = {
      code: ".navTop-container.svelte-j6at6z{display:flex;align-items:center;justify-content:space-between}",
      map: null
    };
    TopBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css$5);
      return `<div class="navTop-container svelte-j6at6z">${slots.default ? slots.default({}) : ``} </div>`;
    });
    css$4 = {
      code: ".links-container.svelte-1x24812.svelte-1x24812{width:100%}.links-container.svelte-1x24812 nav.svelte-1x24812{width:100%;display:flex;justify-content:space-around;align-items:center}.links-container.svelte-1x24812 nav a.svelte-1x24812{width:100%;display:flex;justify-content:space-between;font-weight:900;text-decoration:none;color:inherit;transition:color .5s ease-in-out;font-size:0.75em}.links-container.svelte-1x24812 nav a.svelte-1x24812:hover{color:var(--tertiary-color)}.links-container.svelte-1x24812 nav a #active.svelte-1x24812{padding:5px;background-color:var(--tertiary-color);color:black;font-weight:500;border-radius:5px}",
      map: null
    };
    Links = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let pathName;
      $$result.css.add(css$4);
      return `<div class="links-container svelte-1x24812"><nav class="svelte-1x24812"><a href="/" data-sveltekit-preload-data="hover" class="svelte-1x24812"><span${add_attribute("id", pathName == "/", 0)} class="svelte-1x24812">Home</span></a> <a href="/products" data-sveltekit-preload-data="hover" class="svelte-1x24812"><span${add_attribute("id", pathName == "/products", 0)} class="svelte-1x24812">Products</span></a> <a href="/store" data-sveltekit-preload-data="hover" class="svelte-1x24812"><span${add_attribute("id", pathName == "/order", 0)} class="svelte-1x24812">Order</span></a> <a href="/contact" data-sveltekit-preload-data="hover" class="svelte-1x24812"><span${add_attribute("id", pathName == "/contact", 0)} class="svelte-1x24812">Contact</span></a></nav> </div>`;
    });
    css$3 = {
      code: 'header.svelte-10z7xyf a.svelte-10z7xyf{text-decoration:none}header.svelte-10z7xyf h2.svelte-10z7xyf{text-align:center;color:transparent;font-weight:900;font-family:"Allura";margin-right:1em}.dark.svelte-10z7xyf.svelte-10z7xyf{background:linear-gradient(var(--primary-background), var(--tertiary-background), var(--primary-background));-webkit-background-clip:text;background-clip:text}.light.svelte-10z7xyf.svelte-10z7xyf{background:linear-gradient(var(--secondary-background), var(--tertiary-background), var(--secondary-background));-webkit-background-clip:text;background-clip:text}@media(max-width: 650px){.responsive.svelte-10z7xyf.svelte-10z7xyf{display:none}}',
      map: null
    };
    Name = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<header class="svelte-10z7xyf"><a href="/" class="svelte-10z7xyf"><h2 class="${escape(null_to_empty(`${currentTheme} ${responsive == "yes" && "responsive"}`), true) + " svelte-10z7xyf"}"${add_attribute("style", `font-size: ${size ? size : "normal"};`, 0)}>Yoo
        <br>
        Brands</h2></a> </header>`;
    });
    ...
    css$2 = {
      code: '.product-card.svelte-6p7pnu.svelte-6p7pnu{display:flex;flex-direction:column;align-items:center;transition:transform .3s linear}.product-card.svelte-6p7pnu.svelte-6p7pnu:hover{transform:scale(1.01)}li.svelte-6p7pnu.svelte-6p7pnu{list-style-type:none}.lazy-container{width:100%;display:flex;justify-content:center}#png.svelte-6p7pnu.svelte-6p7pnu{background-color:white}.product-card.svelte-6p7pnu img.svelte-6p7pnu{width:100%;display:flex;max-width:400px;height:300px;border-radius:20px}.product-card.svelte-6p7pnu #product-name.svelte-6p7pnu{color:var(--tertiary-color);font-size:2em;font-weight:900;transition:color .5s ease;font-family:"Mukta"}.product-card.svelte-6p7pnu #product-name.svelte-6p7pnu:hover{color:greenyellow}.product-card.svelte-6p7pnu #product-info.svelte-6p7pnu{transform:translateY(-20px);text-align:center;line-height:1.8em;font-family:"Fira Code";font-size:1em}.product-card.svelte-6p7pnu #product-info.svelte-6p7pnu::first-letter{font-family:"Allura";font-size:2em}.product-card.svelte-6p7pnu #product-info a.svelte-6p7pnu{color:green;text-decoration:none;transition:color .5s ease;font-size:1em}.product-card.svelte-6p7pnu #product-info a.svelte-6p7pnu:hover{color:green}',
      map: null
    };
    Product = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="product-card svelte-6p7pnu">${validate_component(Src, "Lazy").$$render($$result, { class: "lazy-container" }, {}, {
        default: () => {
          return `<img${add_attribute("src", product.imgSrc, 0)}${add_attribute("alt", product.name, 0)}${add_attribute("id", png == "png" && png, 0)} class="svelte-6p7pnu">`;
        }
      })} <p id="product-name" class="svelte-6p7pnu"><span style="font-family: Allura; font-size: 1.3em;">${escape(yoo)} </span>${escape(name)}</p> <p id="product-info" class="svelte-6p7pnu">${escape(product.info.substr(0, 300) + "...")} <li class="svelte-6p7pnu" data-svelte-h="svelte-zz7tti"><a href="/" class="svelte-6p7pnu">see more</a></li></p> </div>`;
    });
    PRODUCTS = [
      {
        name: "Yoo Aesthetics",
      ...
      return `${validate_component(TopBar, "TopBar").$$render($$result, {}, {}, {
        default: () => {
          return `${validate_component(Name, "Name").$$render(
            ...
            {},
            {}
          )} ${validate_component(Links, "Links").$$render($$result, {}, {}, {})} ${validate_component(Theme, "Theme").$$render($$result, { scale: 1.2 }, {}, {})}`;
        }
      })} ${validate_component(YooBrandInfo, "YooBrandInfo").$$render($$result, {}, {}, {})} ${validate_component(_Layout_$1, "YooProducts").$$render($$result, {}, {}, {})}`;
    });
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<main class="container">${validate_component(_Layout_, "Layout").$$render($$result, {}, {}, {})}</main>`;
    });
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    imports4 = ["_app/immutable/nodes/3.6fbbbd1c.js", "_app/immutable/chunks/scheduler.3339ba20.js", "_app/immutable/chunks/index.22f5a88e.js", "_app/immutable/chunks/index.9a9a0e78.js"];
    stylesheets4 = ["_app/immutable/assets/3.44218664.css", "_app/immutable/assets/index.ac58bdd8.css"];
    fonts4 = [];
  }
});
...
var SwipeDetector, css$6, Link, css$52, Links2, _Layout_$2, css$42, Form, css$32, Icon2, css$22, Icons, css$13, _Layout_$12, css3, PhoneUs, _Layout_2, Page2;
var init_page_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/contact/_page.svelte.js"() {
    init_ssr();
    init_Theme();
    SwipeDetector = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      createEventDispatcher();
      return `<main>${slots.default ? slots.default({}) : ``}</main>`;
    });
    css$6 = {
      code: ".link-box.svelte-14rcace.svelte-14rcace{display:flex;flex-direction:row}.link-box#active.svelte-14rcace.svelte-14rcace{background:var(--tertiary-color);color:black;border-radius:1em}.link-box.svelte-14rcace a.svelte-14rcace{width:100%;display:flex;justify-content:space-around;align-items:center;text-decoration:none;color:inherit;transition:color .5s linear}.link-box.svelte-14rcace:not(#active) a.svelte-14rcace:hover{color:var(--tertiary-color)}.link-box.svelte-14rcace a #name.svelte-14rcace{flex-basis:70%;text-align:center;font-size:17px;font-weight:bolder}#icon{flex-basis:30%;height:30px}",
      map: null
    };
    Link = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="link-box svelte-14rcace"${add_attribute("id", pagePath == src ? "active" : "", 0)}><a${add_attribute("href", src, 0)} data-sveltekit-preload-data="hover" class="svelte-14rcace">${validate_component(Icon, "Icon").$$render($$result, { data: iconName, id: "icon" }, {}, {})} <h3 id="name" class="svelte-14rcace">${escape(name)}</h3></a> </div>`;
    });
    css$52 = {
      code: ".sidebar-container.svelte-1yemp9a{position:absolute;top:0;left:0;width:50%;height:100%;max-width:200px;z-index:10;display:none}.sidebar-container#lightTheme.svelte-1yemp9a{background-color:var(--primary-background)}.sidebar-container#darkTheme.svelte-1yemp9a{background-color:var(--secondary-background)}.components-box.svelte-1yemp9a{position:relative;height:inherit;display:flex;flex-direction:column;justify-content:space-evenly}.theme-box.svelte-1yemp9a{display:flex;justify-content:flex-end}",
      map: null
    };
    Links2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let pagePath;
      let sideBarRef;
      let { currentTheme } = $$props;
      createEventDispatcher();
      ...
      return `<div class="sidebar-container svelte-1yemp9a" style="display: none;"${add_attribute("id", currentTheme == "light" ? "lightTheme" : "darkTheme", 0)}${add_attribute("this", sideBarRef, 0)}><div class="components-box svelte-1yemp9a">${validate_component(Link, "Link").$$render(
        $$result,
        {
          name: "Home",
          src: "/",
        ...
        $$result,
        {
          name: "Contact",
          src: "/contact",
          iconName: phoneSquare,
          pagePath
        },
        {},
        {}
      )} <div class="theme-box svelte-1yemp9a">${slots.default ? slots.default({}) : ``}</div></div> </div>`;
    });
    _Layout_$2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let currentTheme;
      return `${validate_component(Links2, "Links").$$render($$result, { currentTheme }, {}, {
        default: () => {
          return `${validate_component(Theme, "Theme").$$render($$result, { scale: 2 }, {}, {})}`;
        }
      })}`;
    });
    css$42 = {
      code: '.form-container.svelte-1bwr9uw.svelte-1bwr9uw{width:100vw}.form-container.svelte-1bwr9uw form.svelte-1bwr9uw{display:flex;flex-direction:column;align-items:center}form.svelte-1bwr9uw input.svelte-1bwr9uw{display:block;width:80%;max-width:350px;margin-bottom:1em;height:50px;border-radius:0.5em;padding:5px 10px;box-sizing:border-box;font-family:"Fira Code";border:1px solid black;outline:none}form.svelte-1bwr9uw input.svelte-1bwr9uw:nth-child(1){text-transform:capitalize}form.svelte-1bwr9uw input.svelte-1bwr9uw:not(:nth-child(3)){font-weight:bold}form.svelte-1bwr9uw input.svelte-1bwr9uw:focus{outline:none;border:1px solid var(--tertiary-color)}form.svelte-1bwr9uw button.svelte-1bwr9uw{width:60px;height:40px;border-radius:5px;border:none;font-weight:bold;background-color:var(--tertiary-color);transition:all .5s linear}form.svelte-1bwr9uw button.svelte-1bwr9uw:hover{background-color:green;color:cornsilk}',
      map: null
    };
    Form = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let inputRef;
      $$result.css.add(css$42);
      return `<div class="form-container svelte-1bwr9uw"><form class="svelte-1bwr9uw"><input type="text" placeholder="Full Name" class="svelte-1bwr9uw"${add_attribute("this", inputRef, 0)}> <input type="text" placeholder="Email" class="svelte-1bwr9uw"> <input type="text" placeholder="Message" class="svelte-1bwr9uw"> <button type="submit" class="svelte-1bwr9uw" data-svelte-h="svelte-oi6wzx">send</button></form> </div>`;
    });
    css$32 = {
    ...
    Icon2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<a${add_attribute("href", src, 0)} class="svelte-wpfmsk"><img${add_attribute("src", imgSrc, 0)}${add_attribute("alt", name, 0)} class="svelte-wpfmsk"> </a>`;
    });
    css$22 = {
      code: ".appIcons-box.svelte-1c3kgku{display:inline}",
      map: null
    };
    Icons = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css$22);
      return `<div class="appIcons-box svelte-1c3kgku">${validate_component(Icon2, "AppIcon").$$render(
        $$result,
        {
        ...
        {},
        {}
      )} ${validate_component(Icon2, "AppIcon").$$render(
        $$result,
        {
          src: "/",
          name: "Snapchat",
    ...
    css$13 = {
      code: `.contact-us_container.svelte-12mac5x.svelte-12mac5x{position:absolute;top:0;left:0;width:100%;height:100%;display:flex;flex-direction:column;justify-content:center;align-items:center;transition:opacity .5s ease}header.svelte-12mac5x a.svelte-12mac5x{color:inherit;text-decoration:inherit}header.svelte-12mac5x a h1.svelte-12mac5x{text-align:center;font-family:"Allura";transition:color 1s linear;font-family:'Caprasimo';font-size:2em;color:transparent;background:radial-gradient(var(--tertiary-color), green);background-clip:text;-webkit-background-clip:text}header.svelte-12mac5x a h1.svelte-12mac5x:hover{color:var(--tertiary-color)}@media(min-width: 768px) and (max-width: 1000px){.contact-us_container.svelte-12mac5x.svelte-12mac5x{transform:translateX(13%)}}`,
      map: null
    };
    _Layout_$12 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let contactUs_Ref;
      createEventDispatcher();
      $$result.css.add(css$13);
      return `<div class="contact-us_container svelte-12mac5x"${add_attribute("this", contactUs_Ref, 0)}><header class="svelte-12mac5x" data-svelte-h="svelte-mxbvkm"><a href="/" class="svelte-12mac5x"><h1 class="svelte-12mac5x">Yoo
            <br>   
            Brand</h1></a></header> ${validate_component(Form, "Form").$$render($$result, {}, {}, {})} <h4 style="font-family: cursive" data-svelte-h="svelte-1efzaxb">Visit us at</h4> ${validate_component(Icons, "AppsIcons").$$render($$result, {}, {}, {})} </div>`;
    });
    css3 = {
    ...
    PhoneUs = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css3);
      return `<div class="phone-container svelte-1uy2iyd"><a href="tel:+2348171983663" class="svelte-1uy2iyd">${validate_component(Icon, "Icon").$$render($$result, { data: phone, scale: 1.2 }, {}, {})}</a> </div>`;
    });
    _Layout_2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div>${validate_component(SwipeDetector, "SwipeDetector").$$render($$result, {}, {}, {
        default: () => {
          return `${validate_component(_Layout_$2, "SideBar").$$render($$result, {}, {}, {})}`;
        }
      })} ${validate_component(_Layout_$12, "ContactUs").$$render($$result, {}, {}, {})} ${validate_component(PhoneUs, "PhoneUs").$$render($$result, {}, {}, {})}</div>`;
    });
    Page2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `${validate_component(_Layout_2, "Layout").$$render($$result, {}, {}, {})}`;
    });
  }
});
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    ...
    imports5 = ["_app/immutable/nodes/4.5e97f5cb.js", "_app/immutable/chunks/scheduler.3339ba20.js", "_app/immutable/chunks/index.22f5a88e.js", "_app/immutable/chunks/index.9a9a0e78.js"];
    stylesheets5 = ["_app/immutable/assets/4.d2187f41.css", "_app/immutable/assets/index.ac58bdd8.css"];
    fonts5 = [];
  }
});
...
var manifest = {
  ...
  _: {
    client: { "start": "_app/immutable/entry/start.2025c0ec.js", "app": "_app/immutable/entry/app.a2b7d7c6.js", "imports": ["_app/immutable/entry/start.2025c0ec.js", "_app/immutable/chunks/scheduler.3339ba20.js", "_app/immutable/chunks/singletons.42be40a7.js", "_app/immutable/entry/app.a2b7d7c6.js", "_app/immutable/chunks/scheduler.3339ba20.js", "_app/immutable/chunks/index.22f5a88e.js"], "stylesheets": [], "fonts": [] },
    nodes: [
