...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.bd9355a3.js", "_app/immutable/chunks/scheduler.3339ba20.js", "_app/immutable/chunks/index.22f5a88e.js", "_app/immutable/chunks/singletons.ca882d1f.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    ...
    css$2 = {
      code: '.product-card.svelte-1m1855a.svelte-1m1855a{display:flex;flex-direction:column;align-items:center;transition:transform .3s linear}.product-card.svelte-1m1855a.svelte-1m1855a:hover{transform:scale(1.01)}li.svelte-1m1855a.svelte-1m1855a{list-style-type:none}#png.svelte-1m1855a.svelte-1m1855a{width:100;background-color:white}.product-card .lazy-container img{width:100%;height:250px;border-radius:20px}.product-card.svelte-1m1855a #product-name.svelte-1m1855a{color:var(--tertiary-color);font-size:2em;font-weight:900;transition:color .5s ease;font-family:"Mukta"}.product-card.svelte-1m1855a #product-name.svelte-1m1855a:hover{color:greenyellow}.product-card.svelte-1m1855a #product-info.svelte-1m1855a{transform:translateY(-20px);text-align:center;line-height:1.8em;font-family:"Fira Code";font-size:1em;padding:0 1em}.product-card.svelte-1m1855a #product-info.svelte-1m1855a::first-letter{font-family:"Allura";font-size:2em}.product-card.svelte-1m1855a #product-info a.svelte-1m1855a{color:green;text-decoration:none;transition:color .5s ease;font-size:1em}.product-card.svelte-1m1855a #product-info a.svelte-1m1855a:hover{color:green}',
      map: null
    };
    Product = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="product-card svelte-1m1855a">${validate_component(Src, "Lazy").$$render($$result, { class: "lazy-container" }, {}, {
        default: () => {
          return `<img${add_attribute("src", product.imgSrc, 0)}${add_attribute("alt", product.name, 0)}${add_attribute("id", png == "png" && png, 0)} class="svelte-1m1855a">`;
        }
      })} <p id="product-name" class="svelte-1m1855a"><span style="font-family: Allura; font-size: 1.3em;">${escape(yoo)} </span>${escape(name)}</p> <p id="product-info" class="svelte-1m1855a">${escape(product.info.substr(0, 300) + "...")} <li class="svelte-1m1855a" data-svelte-h="svelte-zz7tti"><a href="/" class="svelte-1m1855a">see more</a></li></p> </div>`;
    });
    PRODUCTS = [
      {
        name: "Yoo Aesthetics",
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    imports4 = ["_app/immutable/nodes/3.c2381f1d.js", "_app/immutable/chunks/scheduler.3339ba20.js", "_app/immutable/chunks/index.22f5a88e.js", "_app/immutable/chunks/index.9a9a0e78.js"];
    stylesheets4 = ["_app/immutable/assets/3.8ab430d1.css", "_app/immutable/assets/index.ac58bdd8.css"];
    fonts4 = [];
  }
});
...
var manifest = {
  ...
  _: {
    client: { "start": "_app/immutable/entry/start.faee0517.js", "app": "_app/immutable/entry/app.25e3e2ba.js", "imports": ["_app/immutable/entry/start.faee0517.js", "_app/immutable/chunks/scheduler.3339ba20.js", "_app/immutable/chunks/singletons.ca882d1f.js", "_app/immutable/entry/app.25e3e2ba.js", "_app/immutable/chunks/scheduler.3339ba20.js", "_app/immutable/chunks/index.22f5a88e.js"], "stylesheets": [], "fonts": [] },
    nodes: [
